...
/**
 * Main class untuk menjalankan aplikasi peminjaman ruang kuliah.
 */
public class Main {
    public static void main(String[] args) {
        ...
        Mahasiswa[] daftarMahasiswa = {
            ...
            new Mahasiswa("Renjun", "241511100", "Teknik Informatika"),
            new Mahasiswa("Mark", "241511101", "Bahasa Inggris")
        };

        // Daftar Ruang
        RuangKelas[] daftarRuang = {
            new RuangKelas("D-101", "Gedung JTK", 40),
            new RuangKelas("D-112", "Gedung JTK", 35),
            new RuangKelas("D-116", "Gedung JTK", 50)
        };
