...
public class Salesperson implements Comparable
{
    ...
    public int compareTo (Object other)
    {
        ...
        result =  this.totalSales - otherSales.totalSales;

        if (result == 0)
        {
            result = this.lastName.compareTo(otherSales.lastName) * -1;

            if (result == 0)
            {
                result = this.firstName.compareTo(otherSales.firstName) * -1;
            } 
        }
